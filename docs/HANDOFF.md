...
- Durable job pause/resume, reuse of completed results, and stale rejection after a newer note edit.
- Exact browser close refusal when URL changes; durable save remains intact.
...
2. Run `npm run demo && npm start`, open `http://127.0.0.1:8790`, and inspect at a wide desktop viewport and a narrow/mobile-sized viewport. Confirm cards, selection scopes, nested collection navigation, detail dialog, and load-more behavior preserve useful orientation.
